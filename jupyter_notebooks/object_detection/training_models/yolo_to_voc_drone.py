# source: 
# https://gist.githubusercontent.com/goodhamgupta/7ca514458d24af980669b8b1c8bcdafd/raw/3c63a7a1fa3840410bbe0da4034ca9d8604be4ca/yolo_to_voc.py # Script to convert yolo annotations to voc format

# Sample format
# <annotation>
#     <folder>_image_fashion</folder>
#     <filename>brooke-cagle-39574.jpeg</filename>
#     <size>
#         <width>1200</width>
#         <height>800</height>
#         <depth>3</depth>
...
def read_file(file_path):
    ...
    w, h = img.size
    print(file_path)
    file_path = os.path.join(ANNOTATIONS_DIR_PREFIX, file_path)
